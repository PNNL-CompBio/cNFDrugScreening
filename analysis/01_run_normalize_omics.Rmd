...
```{r rna, message=FALSE, warning=FALSE, fig.height=3.5, fig.width=6, out.width="50%", fig.path="figs_for_sara/rna-"}
dir.create("figs_for_sara", showWarnings = FALSE, recursive = TRUE)
...
rna <- run_modality(
  ...
  do_batch_correct = TRUE      #Note this is set to false right now. Doesn't appear to be needed for RNA 
)
```
