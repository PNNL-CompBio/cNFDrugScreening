...
1) **01_run_normalize_omics.Rmd**  
   - *Sources:* `../00_cNF_helper_code.R`, `../01_normalize_batchcorrect_omics.R`  
...
2) **02_analyze_modality.Rmd**  
   - *Sources:* `../00_cNF_helper_code.R`, `../02_analyze_modality_correlations.R`  
...
3) **03_pathway_enrichment.Rmd**  
   - *Sources:* `../00_cNF_helper_code.R`, `../03_leapr_biomarker.R`  
...
- **00_cNF_helper_code.R**: Shared utilities (Synapse helpers, plotting helpers, common metadata).
- **01_normalize_batchcorrect_omics.R**: Normalization / Joining Batches / ComBat batch correction code.
- **02_analyze_modality_correlations.R**: Drug summary plots, correlations (includes separated drug-only + modality-only functions).
- **03_leapr_biomarker.R**: Directional feature ranking + leapR enrichment + pathway plotting.
